      ...
      <section className="panel p-4">
        <div className="flex items-center justify-between gap-3">
          <div>
            ...
            <p className="text-sm text-muted">朗读 2 篇、词汇 10 个、错题循环复习。</p>
          </div>
        ...
        <div className="mt-3 grid gap-2 text-sm md:grid-cols-3">
          <p>朗读进度：{taskProgress?.readingDone ?? 0}/{taskProgress?.readingTarget ?? 2}</p>
          <p>词汇进度：{taskProgress?.vocabDone ?? 0}/{taskProgress?.vocabTarget ?? 10}</p>
